...
from app.services.browser_bridge.runner import browser_bridge_manager
...
async def lifespan(_app: FastAPI):
    ...
    yield
    browser_bridge_manager.shutdown()
...
app = FastAPI(title=settings.app_name, version="0.6.0-browser-experiment", lifespan=lifespan)
app.include_router(health_router, prefix="/api")
app.include_router(ai_router, prefix="/api")
app.include_router(browser_bridge_router, prefix="/api")
